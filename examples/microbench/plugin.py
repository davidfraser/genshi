...
class MarkupTemplateEnginePluginTestCase(unittest.TestCase):
    ...
    def test_load_template_from_file(self):
        plugin = MarkupTemplateEnginePlugin()
        tmpl = plugin.load_template((PACKAGE + '.templates.test').lstrip("."))
...
<html lang="en">
  ...
  <body>
    ...
    def test_render_fragment_with_doctype(self):
        ...
        tmpl = plugin.load_template((PACKAGE + '.templates.test_no_doctype').lstrip("."))
        output = plugin.render({'message': 'Hello'}, template=tmpl,
                               fragment=True)
  ...
  <body>
    ...
    def test_helper_functions(self):
        plugin = MarkupTemplateEnginePlugin()
        tmpl = plugin.load_template((PACKAGE + '.templates.functions').lstrip("."))
...
class TextTemplateEnginePluginTestCase(unittest.TestCase):
    ...
    def test_init_with_new_syntax(self):
        ...
        tmpl = plugin.load_template((PACKAGE + '.templates.new_syntax').lstrip("."))
